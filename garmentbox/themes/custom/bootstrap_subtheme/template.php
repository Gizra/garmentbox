...
function bootstrap_subtheme_preprocess_node(&$variables) {
  ...
  // default.
  $preprocess_function = "bootstrap_subtheme_preprocess_{$node->type}_node{$view_mode}";
 ...
 *
 * @see bootstrap_subtheme_preprocess_node().
 */
function bootstrap_subtheme_preprocess_material_node(&$variables) {
